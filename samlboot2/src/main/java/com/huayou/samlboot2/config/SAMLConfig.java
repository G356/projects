...
import com.huayou.samlboot2.certificate.KeystoreFactory;
import com.huayou.samlboot2.spring.SpringResourceWrapperOpenSAMLResource;
import com.huayou.samlboot2.spring.security.SAMLUserDetailsServiceImpl;
...
public class SAMLConfig {
    ...
    public SAMLLogoutFilter samlLogoutFilter() {
        ...
        filter.setFilterProcessesUrl("/sso-logout");//saml/logout
        return filter;
    }
    ...
    public SAMLLogoutProcessingFilter samlLogoutProcessingFilter() {
        ...
        filter.setFilterProcessesUrl("/sso-logout");///saml/SingleLogout
        return filter;
    }
    ...
    public MetadataGenerator metadataGenerator(KeyManager keyManager) {
        ...
        generator.setEntityId("https://localhost:5000/sso-metadata/sso-metadata.html");//localhost-demo
    ...
    public SAMLProcessingFilter samlWebSSOProcessingFilter(){
        ...
        filter.setFilterProcessesUrl("/ssologin");//saml/SSO
        return filter;
    }
    ...
    public SAMLEntryPoint samlEntryPoint() {
        ...
        entryPoint.setFilterProcessesUrl("/ssologin");//saml/login
        return entryPoint;
    }
